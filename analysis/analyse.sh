...
python3 plots.py --plot "annotation_cent_box_plt" --mode "centralized" --root_dir $root_dir  --param_tuning_df_file  $param_tuning_df_file \
--metric "accuracy"


# Plot heatmap for various metrics on dif rounds for various n_epochs
python3 plots.py --plot "annotation_metric_heatmap" --param_tuning_df_file $param_tuning_df_file --format 'png'

# Plot communication efficiency hist
python3 plots.py --plot "annotation_communication" --param_tuning_df_file $param_tuning_df_file

## Plot metric(Accuracy) changes over rounds and epochs
python3 plots.py --plot "annotation_accuracy_changes" --param_tuning_df_file $param_tuning_df_file --format 'svg'

# Plot confusion matrices federated vs centralized for different datasets
python3 plots.py --plot "annotation_conf_matrix" --root_dir $root_dir --param_tuning_pkl $param_tuning_pkl_file --data_dir $data_dir --param_tuning_df_file $param_tuning_df_file

# Plot best metrics
python3 plots.py --plot "annotation_best_metrics" --root_dir "${root_dir}/output/annotation" --param_tuning_df_file $param_tuning_df_file --format 'png'
